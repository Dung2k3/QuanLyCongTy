...
namespace QuanLyCongTy
{
    public class ThongTinDAO
    {
        ...
        public ClassThongTin LayThongTin(string MaNV)
        {
            ...
            return  new ClassThongTin(dr[0].ToString(), dr[1].ToString(), dr[2].ToString(), dr[3].ToString(),DateTime.Parse(dr[4].ToString()), 
